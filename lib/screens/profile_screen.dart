...
class LecturerProfileScreen extends StatefulWidget {
  ...
  const LecturerProfileScreen({super.key, required this.userData});

  @override
  _LecturerProfileScreenState createState() => _LecturerProfileScreenState();
}
...
class _LecturerProfileScreenState extends State<LecturerProfileScreen> {
  ...
  Future<void> _pickAndUploadImage() async {
    ...
    try {
      ...
      await _firestore.collection('lecturers').doc(userId).update({'profileImage': imageUrl});
  ...
  Future<void> _deleteAccount(BuildContext context) async {
    try {
      ...
      await _firestore.collection('lecturers').doc(userId).delete();
